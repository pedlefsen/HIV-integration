...
## SCRIData:
# Unique ISs #
SCRIData.the.samples.Rda.filename <- paste( TenofovirDataDir, "SCRIData_WangIS_samples_Aug27_10K.Rda", sep = "" );
SCRIData.feature.nulls.Rda.filename <- paste( TenofovirDataDir, "SCRIData_WangIS_samples_Aug27_featureCounts.Rda", sep = "" );
SCRIData.cooccurrence.nulls.Rda.filename <- paste( TenofovirDataDir, "SCRIData_WangIS_samples_Aug27_cooccurrenceCounts.Rda", sep = "" );
SCRIData.cooccurrence.twoSubjectGenes.nulls.Rda.filename <- paste( TenofovirDataDir, "SCRIData_WangIS_samples_Aug27_cooccurrence.twoSubjectGenes.Rda", sep = "" );
# ALL ISs #
SCRIData.IS.the.samples.Rda.filename <- paste( TenofovirDataDir, "SCRIData_WangIS_allIS_samples_Aug27_10K.Rda", sep = "" );
SCRIData.IS.feature.nulls.Rda.filename <- paste( TenofovirDataDir, "SCRIData_WangIS_allIS_samples_Aug27_featureCounts.Rda", sep = "" );
# IS Counts #
SCRIData.countIS.the.samples.Rda.filename <- paste( TenofovirDataDir, "SCRIData_WangIS_countIS_samples_Aug27_10K.Rda", sep = "" );
SCRIData.countIS.feature.nulls.Rda.filename <- paste( TenofovirDataDir, "SCRIData_WangIS_countIS_samples_Aug27_featureCounts.Rda", sep = "" );
...
SCRIMalderelliData.num.uniqueIS.isCancer.by.subject.by.time <- 
  t( sapply( SCRIMalderelliData.subjectIDs, function( .subject.id ) {
      apply( ( SCRIMalderelliData[ ( SCRIMalderelliData$Pt. == .subject.id ) & ( SCRIMalderelliData$isCancer > 0 ), c( "X1st", "X2nd", "X3rd" ) ] > 0 ), 2, sum );
  } ) );
...
SCRIMalderelliData.num.uniqueIS.isAnyCancer.GO.by.subject.by.time <- 
  t( sapply( SCRIMalderelliData.subjectIDs, function( .subject.id ) {
      apply( ( SCRIMalderelliData[ ( SCRIMalderelliData$Pt. == .subject.id ) & ( SCRIMalderelliData$isAnyCancer.GO > 0 ), c( "X1st", "X2nd", "X3rd" ) ] > 0 ), 2, sum );
  } ) );
...
WangData.num.uniqueIS.isDownregulatedByTenofovir.Rectal <- 
    sum( WangData$isDownregulatedByTenofovir.Rectal > 0 );
WangData.num.uniqueIS.NOTisDownregulatedByTenofovir.Rectal <- 
    sum( WangData$isDownregulatedByTenofovir.Rectal == 0 );
WangData.frac.uniqueIS.isDownregulatedByTenofovir.Rectal <- 
    mean( WangData$isDownregulatedByTenofovir.Rectal > 0 );
WangData.frac.uniqueIS.isDownregulatedByTenofovir.Rectal

SCRIMalderelliData.num.uniqueIS.isDownregulatedByTenofovir.Rectal.by.subject.by.time <- 
  t( sapply( SCRIMalderelliData.subjectIDs, function( .subject.id ) {
      apply( ( SCRIMalderelliData[ ( SCRIMalderelliData$Pt. == .subject.id ) & ( SCRIMalderelliData$isDownregulatedByTenofovir.Rectal > 0 ), c( "X1st", "X2nd", "X3rd" ) ] > 0 ), 2, sum );
  } ) );
...
SCRIMalderelliData.num.uniqueIS.isDownregulatedByTenofovir.Rectal <- 
    sum( SCRIMalderelliData$isDownregulatedByTenofovir.Rectal > 0 );
...
SCRIMalderelliData.num.uniqueIS.proliferating.isDownregulatedByTenofovir.Rectal <- 
    sum( ( SCRIMalderelliData$Proliferating > 0 ) & ( SCRIMalderelliData$isDownregulatedByTenofovir.Rectal > 0 ) );
...
WangData.num.uniqueIS.isUpregulatedByTenofovir.Rectal <- 
    sum( WangData$isUpregulatedByTenofovir.Rectal > 0 );
WangData.num.uniqueIS.NOTisUpregulatedByTenofovir.Rectal <- 
    sum( WangData$isUpregulatedByTenofovir.Rectal == 0 );
WangData.frac.uniqueIS.isUpregulatedByTenofovir.Rectal <- 
    mean( WangData$isUpregulatedByTenofovir.Rectal > 0 );
WangData.frac.uniqueIS.isUpregulatedByTenofovir.Rectal

SCRIMalderelliData.num.uniqueIS.isUpregulatedByTenofovir.Rectal.by.subject.by.time <- 
  t( sapply( SCRIMalderelliData.subjectIDs, function( .subject.id ) {
      if( sum( ( SCRIMalderelliData$Pt. == .subject.id ) & ( SCRIMalderelliData$isUpregulatedByTenofovir.Rectal > 0 ) ) == 0 ) {
          .rv <- rep( 0, 3 );
          names( .rv ) <- c( "X1st", "X2nd", "X3rd" );
          return( .rv );
      } else {
          apply( ( SCRIMalderelliData[ ( SCRIMalderelliData$Pt. == .subject.id ) & ( SCRIMalderelliData$isUpregulatedByTenofovir.Rectal > 0 ), c( "X1st", "X2nd", "X3rd" ) ] > 0 ), 2, sum );
      }
  } ) );
...
SCRIMalderelliData.num.uniqueIS.isUpregulatedByTenofovir.Rectal <- 
    sum( SCRIMalderelliData$isUpregulatedByTenofovir.Rectal > 0 );
...
SCRIMalderelliData.num.uniqueIS.proliferating.isUpregulatedByTenofovir.Rectal <- 
    sum( ( SCRIMalderelliData$Proliferating > 0 ) & ( SCRIMalderelliData$isUpregulatedByTenofovir.Rectal > 0 ) );
...
WangData.num.uniqueIS.isDownregulatedByTenofovir.exvivo <- 
    sum( WangData$isDownregulatedByTenofovir.exvivo > 0 );
WangData.num.uniqueIS.NOTisDownregulatedByTenofovir.exvivo <- 
    sum( WangData$isDownregulatedByTenofovir.exvivo == 0 );
WangData.frac.uniqueIS.isDownregulatedByTenofovir.exvivo <- 
    mean( WangData$isDownregulatedByTenofovir.exvivo > 0 );
WangData.frac.uniqueIS.isDownregulatedByTenofovir.exvivo

SCRIMalderelliData.num.uniqueIS.isDownregulatedByTenofovir.exvivo.by.subject.by.time <- 
  t( sapply( SCRIMalderelliData.subjectIDs, function( .subject.id ) {
      apply( ( SCRIMalderelliData[ ( SCRIMalderelliData$Pt. == .subject.id ) & ( SCRIMalderelliData$isDownregulatedByTenofovir.exvivo > 0 ), c( "X1st", "X2nd", "X3rd" ) ] > 0 ), 2, sum );
  } ) );
...
SCRIMalderelliData.num.uniqueIS.isDownregulatedByTenofovir.exvivo <- 
    sum( SCRIMalderelliData$isDownregulatedByTenofovir.exvivo > 0 );
...
SCRIMalderelliData.num.uniqueIS.proliferating.isDownregulatedByTenofovir.exvivo <- 
    sum( ( SCRIMalderelliData$Proliferating > 0 ) & ( SCRIMalderelliData$isDownregulatedByTenofovir.exvivo > 0 ) );
...
WangData.num.uniqueIS.isUpregulatedByTenofovir.exvivo <- 
    sum( WangData$isUpregulatedByTenofovir.exvivo > 0 );
WangData.num.uniqueIS.NOTisUpregulatedByTenofovir.exvivo <- 
    sum( WangData$isUpregulatedByTenofovir.exvivo == 0 );
WangData.frac.uniqueIS.isUpregulatedByTenofovir.exvivo <- 
    mean( WangData$isUpregulatedByTenofovir.exvivo > 0 );
WangData.frac.uniqueIS.isUpregulatedByTenofovir.exvivo

SCRIMalderelliData.num.uniqueIS.isUpregulatedByTenofovir.exvivo.by.subject.by.time <- 
  t( sapply( SCRIMalderelliData.subjectIDs, function( .subject.id ) {
      apply( ( SCRIMalderelliData[ ( SCRIMalderelliData$Pt. == .subject.id ) & ( SCRIMalderelliData$isUpregulatedByTenofovir.exvivo > 0 ), c( "X1st", "X2nd", "X3rd" ) ] > 0 ), 2, sum );
  } ) );
...
SCRIMalderelliData.num.uniqueIS.isUpregulatedByTenofovir.exvivo <- 
    sum( SCRIMalderelliData$isUpregulatedByTenofovir.exvivo > 0 );
...
SCRIMalderelliData.num.uniqueIS.proliferating.isUpregulatedByTenofovir.exvivo <- 
    sum( ( SCRIMalderelliData$Proliferating > 0 ) & ( SCRIMalderelliData$isUpregulatedByTenofovir.exvivo > 0 ) );
...
if( file.exists( SCRIMalderelliData.genesWithAnyISs.the.samples.Rda.filename ) ) {
    ...
    SCRIMalderelliData.genesWithAnyISs.the.samples <- lapply( SCRIMalderelliData.num.genesWithAnyISs.by.subject.and.total.and.totalProliferating, function ( .num.integration.sites ) {
        ...
        t( rmultinom( num.samples, .num.integration.sites, WangData.num.uniquegenesWithAnyISs.by.gene ) )
    } );
...
SCRIMalderelliData.genesWithAnyISs.isCancer.Wang.fisher.table <- cbind(
    ...
    c( WangData.num.uniquegenesWithAnyISs.isCancer, WangData.num.uniquegenesWithAnyISs.NOTisCancer ) );
...
SCRIMalderelliData.genesWithAnyISs.isAnyCancer.GO.Wang.fisher.table <- cbind(
    ...
    c( WangData.num.uniquegenesWithAnyISs.isAnyCancer.GO, WangData.num.uniquegenesWithAnyISs.NOTisAnyCancer.GO ) );
...
SCRIMalderelliData.num.genesWithAnyISs.isDownregulatedByTenofovir.Rectal <- 
    sum( SCRIMalderelliData[ SCRIMalderelliData$isDownregulatedByTenofovir.Rectal > 0, time.points ] );
...
SCRIMalderelliData.genesWithAnyISs.isDownregulatedByTenofovir.Rectal.Wang.fisher.table <- cbind(
    ...
    c( WangData.num.uniquegenesWithAnyISs.isDownregulatedByTenofovir.Rectal, WangData.num.uniquegenesWithAnyISs.NOTisDownregulatedByTenofovir.Rectal ) );
...
SCRIMalderelliData.num.genesWithAnyISs.proliferating.isDownregulatedByTenofovir.Rectal <- 
    sum( SCRIMalderelliData[ ( SCRIMalderelliData$Proliferating > 0 ) & ( SCRIMalderelliData$isDownregulatedByTenofovir.Rectal > 0 ), time.points ] );
...
SCRIMalderelliData.num.genesWithAnyISs.isUpregulatedByTenofovir.Rectal <- 
    sum( SCRIMalderelliData[ SCRIMalderelliData$isUpregulatedByTenofovir.Rectal > 0, time.points ] );
...
SCRIMalderelliData.genesWithAnyISs.isUpregulatedByTenofovir.Rectal.Wang.fisher.table <- cbind(
    ...
    c( WangData.num.uniquegenesWithAnyISs.isUpregulatedByTenofovir.Rectal, WangData.num.uniquegenesWithAnyISs.NOTisUpregulatedByTenofovir.Rectal ) );
...
SCRIMalderelliData.num.genesWithAnyISs.proliferating.isUpregulatedByTenofovir.Rectal <- 
    sum( SCRIMalderelliData[ ( SCRIMalderelliData$Proliferating > 0 ) & ( SCRIMalderelliData$isUpregulatedByTenofovir.Rectal > 0 ), time.points ] );
...
SCRIMalderelliData.num.genesWithAnyISs.isDownregulatedByTenofovir.exvivo <- 
    sum( SCRIMalderelliData[ SCRIMalderelliData$isDownregulatedByTenofovir.exvivo > 0, time.points ] );
...
SCRIMalderelliData.genesWithAnyISs.isDownregulatedByTenofovir.exvivo.Wang.fisher.table <- cbind(
    ...
    c( WangData.num.uniquegenesWithAnyISs.isDownregulatedByTenofovir.exvivo, WangData.num.uniquegenesWithAnyISs.NOTisDownregulatedByTenofovir.exvivo ) );
...
SCRIMalderelliData.num.genesWithAnyISs.proliferating.isDownregulatedByTenofovir.exvivo <- 
    sum( SCRIMalderelliData[ ( SCRIMalderelliData$Proliferating > 0 ) & ( SCRIMalderelliData$isDownregulatedByTenofovir.exvivo > 0 ), time.points ] );
...
SCRIMalderelliData.num.genesWithAnyISs.isUpregulatedByTenofovir.exvivo <- 
    sum( SCRIMalderelliData[ SCRIMalderelliData$isUpregulatedByTenofovir.exvivo > 0, time.points ] );
...
SCRIMalderelliData.genesWithAnyISs.isUpregulatedByTenofovir.exvivo.Wang.fisher.table <- cbind(
    ...
    c( WangData.num.uniquegenesWithAnyISs.isUpregulatedByTenofovir.exvivo, WangData.num.uniquegenesWithAnyISs.NOTisUpregulatedByTenofovir.exvivo ) );
...
SCRIMalderelliData.num.genesWithAnyISs.proliferating.isUpregulatedByTenofovir.exvivo <- 
    sum( SCRIMalderelliData[ ( SCRIMalderelliData$Proliferating > 0 ) & ( SCRIMalderelliData$isUpregulatedByTenofovir.exvivo > 0 ), time.points ] );
...
Table~\ref{tab:SCRIMalderelliData.IS.p.values.by.feature.adjusted.secondaryFeatures.Tenofovir} shows the Holm-adjusted p-values of the IS test evaluating the secondary Tenofovir features in the SCRIMalderelli data set.

\begin{minipage}{\linewidth}
\centering
\par
\bigskip
\captionof{table}{\bf SCRIMalderelli ISs vs Wang: Holm-adjusted p-values of secondary Tenofovir features} \label{tab:SCRIMalderelliData.IS.p.values.by.feature.adjusted.secondaryFeatures.Tenofovir}
<<echo = FALSE, results = tex>>=
.tab <- as.matrix( SCRIMalderelliData.IS.p.values.by.feature.adjusted[ secondaryFeatures.Tenofovir ] );
colnames( .tab ) <- "Holm-adjusted p-value";
print( xtable( .tab, digits=4 ), floating = FALSE );
@ 
\par
\bigskip
SCRIMalderelli ISs vs Wang: Holm-adjusted p-values of secondary Tenofovir features.
\par
\bigskip
\end{minipage}


Table~\ref{tab:SCRIMalderelliData.IS.proliferating.p.values.by.feature.adjusted.secondaryFeatures.Tenofovir} shows the Holm-adjusted p-values of the proliferating IS test evaluating the secondary Tenofovir features in the SCRIMalderelli data set.

\begin{minipage}{\linewidth}
\centering
\par
\bigskip
\captionof{table}{\bf SCRIMalderelli proliferating ISs vs Wang: Holm-adjusted p-values of secondary Tenofovir features} \label{tab:SCRIMalderelliData.IS.proliferating.p.values.by.feature.adjusted.secondaryFeatures.Tenofovir}
<<echo = FALSE, results = tex>>=
.tab <- as.matrix( SCRIMalderelliData.IS.p.values.proliferating.by.feature.adjusted[ secondaryFeatures.Tenofovir ] );
colnames( .tab ) <- "Holm-adjusted p-value";
print( xtable( .tab, digits=4 ), floating = FALSE );
@ 
\par
\bigskip
SCRIMalderelli proliferating ISs vs Wang: Holm-adjusted p-values of secondary Tenofovir features.
\par
\bigskip
\end{minipage}


Table~\ref{tab:SCRIMalderelliData.IS.nonproliferating.p.values.by.feature.adjusted.secondaryFeatures.Tenofovir} shows the Holm-adjusted p-values of the nonproliferating IS test evaluating the secondary Tenofovir features in the SCRIMalderelli data set.

\begin{minipage}{\linewidth}
\centering
\par
\bigskip
\captionof{table}{\bf SCRIMalderelli nonproliferating ISs vs Wang: Holm-adjusted p-values of secondary Tenofovir features} \label{tab:SCRIMalderelliData.IS.nonproliferating.p.values.by.feature.adjusted.secondaryFeatures.Tenofovir}
<<echo = FALSE, results = tex>>=
.tab <- as.matrix( SCRIMalderelliData.IS.p.values.nonproliferating.by.feature.adjusted[ secondaryFeatures.Tenofovir ] );
colnames( .tab ) <- "Holm-adjusted p-value";
print( xtable( .tab, digits=4 ), floating = FALSE );
@ 
\par
\bigskip
SCRIMalderelli nonproliferating ISs vs Wang: Holm-adjusted p-values of secondary Tenofovir features.
\par
\bigskip
\end{minipage}
